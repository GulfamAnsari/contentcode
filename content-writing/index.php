...
<body>
  ...
  <section class="project-detail section-padding">
    <div class="container">
      <div class="row">
        <h3 class="container">We offer Content Writing services for brands, businesses, influencers, bloggers, and coaches. This is your one-stop solution when under deadline to ideate content and branding strategies. You can sit back and relax while the experts brainstorm their ideas to deliver engaging content.</h3>
      ...
      <div class="col-lg-9 mx-auto col-12" data-aos="fade-up">
        <div class="client-info mt-lg-5 py-lg-5">
          <h3>Contact us to write for blogs, brochures, websites, Emailer, Social Media Posts, PowerPoint presentation, Advertisements, mobile applications, press release, speech.</h3>
